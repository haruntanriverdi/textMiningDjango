...
from tensorflow.keras.layers import Dense, GlobalAveragePooling2D, Input, Embedding, LSTM, Dot, Reshape, Concatenate, \
    BatchNormalization, GlobalMaxPooling2D, Dropout, Add, MaxPooling2D, GRU, AveragePooling2D
...
chexnet_weights = "main/chexnet_weights/brucechou1983_CheXNet_Keras_0.3.0_weights.h5"
